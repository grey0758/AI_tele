...
if __name__ == "__main__":
    appid = "8755862075"
    token = "34g-ejB_nANGoOH4SiZ8eG8wefJ6EXnq"  # 使用config.py中的正确token
    spk_id = "S_rzQESAIG1"
    train(appid=appid, token=token, audio_path=r"E:\xyh\g-trow0936\AI_telephone_consultant\app\tts_log1\809e8161934b52a8755c8c7383efdf44.wav", spk_id=spk_id)
